...
- **DBMS** : DB의 기능을 실현하기 위해 작성된 구체적인 **소프트웨어**
- **RDBMS** : RDB에 한정한 것으로 Relational의 R을 붙인 것

# 소프트웨어와 데이터베이스의 관계

- **SI(System Integration)**
  - 시스템 구축을 위해 데이터베이스와 여러 소프트웨어를 조합하여 만드는 작업
...
- 시스템의 목적이나 규모에 따라 다르지만, 사용되는 소프트웨어는 크게 3가지
  ...
  3. **애플리케이션**
- 위 소프트웨어들은 **계층성**이 있음
- 한 레이어(계층)의 SW가 동작하지 않으면 상위 레이어의 SW는 설치해도 동작X or 설치 조차X
...
- OS와 DBMS의 조합은 자유도가 높음
  - 예외) SQL Server는 Windows 이외의 OS와 조합 불가능
  - SQL Server 개발사인 Microsoft가 구현물을 제공 안함
